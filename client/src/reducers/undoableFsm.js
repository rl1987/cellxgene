...
const createFsmTransitions = (
  ...
  return [
    ...
    /* Gene set request by user */
    {
      event: "gene set start",
      from: "init",
      to: "gene set request in progress",
      action: stashPending,
    },
    {
      event: "request gene set error",
      from: "gene set request in progress",
      to: "gene set error in progress",
      action: skip,
    },
    {
      event: "gene set error",
      from: "gene set error in progress",
      to: "done",
      action: cancelPending,
    },
    {
      event: "gene set complete",
      from: "gene set request in progress",
      to: "done",
      action: applyPending,
    },
